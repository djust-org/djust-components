    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            ...
            mark_read_event=mark_read_event, toggle_event=toggle_event,
            is_open=is_open, title=title, custom_class=custom_class,
            **kwargs,
        )
    ...
    def _render_custom(self) -> str:
        ...
        if self.is_open:
            ...
            if not self.notifications:
                empty = (
                    '<div class="dj-notif-popover__empty">No notifications</div>'
                )
            panel_html = (

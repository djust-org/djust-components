...
class TimePicker(Component):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            name=name, value=value, event=event, format_24h=format_24h,
            min_time=min_time, max_time=max_time, step=step,
            disabled=disabled, label=label, custom_class=custom_class,
            **kwargs,
        )
        self.name = name
        self.value = value
    ...
    def _render_custom(self) -> str:
        ...
        parts.append(
            ...
            f'value="{html.escape(self.value)}"{event_attr}>'
        )
        ...
        if self.format_24h:
            ...
            hour_max = 13
            hour_start = 1
        parts.append(f'<div class="dj-time-picker__controls">')

...
class ImageLightbox(Component):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            images=images, active=active, open=open,
            close_event=close_event, navigate_event=navigate_event,
            show_counter=show_counter, custom_class=custom_class, **kwargs,
        )

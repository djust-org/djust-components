...
class ResizablePanel(Component):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            content=content, direction=direction, min_size=min_size,
            max_size=max_size, initial_size=initial_size, disabled=disabled,
    ...
    def _render_custom(self) -> str:
        ...
        if self.max_size != "none":
            style = f'style="{size_prop}:{e_initial};min-{size_prop}:{e_min};max-{size_prop}:{e_max}"'

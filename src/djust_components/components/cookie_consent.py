...
class CookieConsent(Component):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            message=message, accept_event=accept_event,
            reject_event=reject_event, accept_label=accept_label,
            reject_label=reject_label, privacy_url=privacy_url,
            show_reject=show_reject, position=position,

...
class JsonViewer(Component):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            data=data, collapsed_depth=collapsed_depth,
            root_label=root_label, copy_button=copy_button,
    ...
    def _render_node(self, value, depth: int = 0) -> str:
        ...
        if isinstance(value, str):
            return f'<span class="dj-json__value dj-json__value--string">"{html.escape(value)}"</span>'

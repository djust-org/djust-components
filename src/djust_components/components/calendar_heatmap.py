...
class CalendarHeatmap(Component):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            data=data, year=year, title=title, color_empty=color_empty,
            color_min=color_min, color_max=color_max, cell_size=cell_size,
            cell_gap=cell_gap, show_month_labels=show_month_labels,
            show_day_labels=show_day_labels, custom_class=custom_class,
            **kwargs,
        )
        self.data = data or {}
        self.year = year

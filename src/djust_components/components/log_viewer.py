...
class LogViewer(Component):
    ...
    LEVEL_RE = re.compile(r'\b(INFO|WARN(?:ING)?|ERROR|DEBUG|TRACE|FATAL|CRITICAL)\b', re.IGNORECASE)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            lines=lines, stream_event=stream_event,
            show_line_numbers=show_line_numbers, auto_scroll=auto_scroll,
            filter_level=filter_level, wrap=wrap, max_lines=max_lines,

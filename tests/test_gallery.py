...
class TestDiscovery:
    ...
    def test_discover_component_classes(self):
        ...
        expected = {"ActivityFeed", "Alert", "ApprovalGate", "AuditLog", "AvatarGroup", "Badge", "BarChart", "BottomSheet", "Button", "CalendarHeatmap", "CalendarView", "Card", "ChatBubble", "CodeSnippet", "CollabSelection", "ComparisonTable", "ConnectionStatus", "ContentLoader", "ConversationThread", "CookieConsent", "Countdown", "CopyableText", "CurrencyInput", "CursorsOverlay", "DashboardGrid", "DataGrid", "DependentSelect", "DiffViewer", "DropdownMenu", "ErrorBoundary", "ExpandableText", "ExportDialog", "FeedbackWidget", "FieldError", "FileTree", "FormArray", "FormErrors", "GanttChart", "Heatmap", "HoverCard", "ImageCropper", "ImageLightbox", "ImportWizard", "InfiniteScroll", "JsonViewer", "LineChart", "LiveCounter", "LiveIndicator", "LogViewer", "Markdown", "MarkdownEditor", "MarkdownTextarea", "MasonryGrid", "MentionsInput", "Meter", "ModelSelector", "MultimodalInput", "NotificationBadge", "NotificationPopover", "OrgChart", "PageAlert", "PieChart", "PivotTable", "PresenceAvatars", "Progress", "ProgressCircle", "Reactions", "RelativeTime", "ResizablePanel", "ResponsiveImage", "RichSelect", "ScrollSpy", "ScrollToTop", "SegmentedProgress", "ServerEventToastMixin", "SignaturePad", "SkeletonFactory", "SortableGrid", "SortableList", "SourceCitation", "Sparkline", "Spinner", "StatCard", "StatusDot", "StatusIndicator", "StreamingText", "Switch", "Tag", "Terminal", "ThinkingIndicator", "TimePicker", "Toast", "TokenCounter", "Tour", "Treemap", "TruncatedList", "Wizard"}

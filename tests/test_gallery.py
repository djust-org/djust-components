...
class TestDiscovery:
    ...
    def test_discover_component_classes(self):
        ...
        expected = {"Alert", "ApprovalGate", "AvatarGroup", "Badge", "Button", "Card", "ChatBubble", "CodeSnippet", "ConnectionStatus", "ContentLoader", "ConversationThread", "CopyableText", "CurrencyInput", "DataGrid", "DependentSelect", "ExpandableText", "FeedbackWidget", "FieldError", "FormErrors", "HoverCard", "LiveCounter", "Markdown", "MarkdownTextarea", "MentionsInput", "ModelSelector", "MultimodalInput", "NotificationBadge", "NotificationPopover", "PresenceAvatars", "Progress", "ProgressCircle", "RelativeTime", "ResponsiveImage", "RichSelect", "ScrollToTop", "SegmentedProgress", "ServerEventToastMixin", "SkeletonFactory", "SourceCitation", "Spinner", "StatCard", "StatusDot", "StatusIndicator", "StreamingText", "Switch", "Tag", "ThinkingIndicator", "Toast", "TokenCounter", "TruncatedList"}

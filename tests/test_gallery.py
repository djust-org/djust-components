...
class TestDiscovery:
    ...
    def test_discover_component_classes(self):
        ...
        expected = {"Alert", "ApprovalGate", "AuditLog", "AvatarGroup", "Badge", "BarChart", "BottomSheet", "Button", "CalendarHeatmap", "Card", "ChatBubble", "CodeSnippet", "ConnectionStatus", "ContentLoader", "ConversationThread", "CookieConsent", "Countdown", "CopyableText", "CurrencyInput", "DashboardGrid", "DataGrid", "DependentSelect", "DropdownMenu", "ErrorBoundary", "ExpandableText", "ExportDialog", "FeedbackWidget", "FieldError", "FormArray", "FormErrors", "Heatmap", "HoverCard", "ImageCropper", "ImageLightbox", "ImportWizard", "InfiniteScroll", "LineChart", "LiveCounter", "Markdown", "MarkdownTextarea", "MentionsInput", "Meter", "ModelSelector", "MultimodalInput", "NotificationBadge", "NotificationPopover", "PageAlert", "PieChart", "PresenceAvatars", "Progress", "ProgressCircle", "RelativeTime", "ResizablePanel", "ResponsiveImage", "RichSelect", "ScrollSpy", "ScrollToTop", "SegmentedProgress", "ServerEventToastMixin", "SignaturePad", "SkeletonFactory", "SortableGrid", "SortableList", "SourceCitation", "Sparkline", "Spinner", "StatCard", "StatusDot", "StatusIndicator", "StreamingText", "Switch", "Tag", "ThinkingIndicator", "TimePicker", "Toast", "TokenCounter", "Treemap", "TruncatedList", "Wizard"}

...
class TestDiscovery:
    ...
    def test_discover_component_classes(self):
        ...
        expected = {"Alert", "ApprovalGate", "AuditLog", "AvatarGroup", "Badge", "BottomSheet", "Button", "Card", "ChatBubble", "CodeSnippet", "ConnectionStatus", "ContentLoader", "ConversationThread", "CookieConsent", "Countdown", "CopyableText", "CurrencyInput", "DashboardGrid", "DataGrid", "DependentSelect", "DropdownMenu", "ErrorBoundary", "ExpandableText", "ExportDialog", "FeedbackWidget", "FieldError", "FormArray", "FormErrors", "HoverCard", "ImageCropper", "ImageLightbox", "ImportWizard", "InfiniteScroll", "LiveCounter", "Markdown", "MarkdownTextarea", "MentionsInput", "Meter", "ModelSelector", "MultimodalInput", "NotificationBadge", "NotificationPopover", "PageAlert", "PresenceAvatars", "Progress", "ProgressCircle", "RelativeTime", "ResizablePanel", "ResponsiveImage", "RichSelect", "ScrollSpy", "ScrollToTop", "SegmentedProgress", "ServerEventToastMixin", "SignaturePad", "SkeletonFactory", "SortableGrid", "SortableList", "SourceCitation", "Spinner", "StatCard", "StatusDot", "StatusIndicator", "StreamingText", "Switch", "Tag", "ThinkingIndicator", "TimePicker", "Toast", "TokenCounter", "TruncatedList", "Wizard"}

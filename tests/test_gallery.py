...
class TestDiscovery:
    ...
    def test_discover_component_classes(self):
        ...
        expected = {"Alert", "Badge", "Button", "Card", "DataGrid", "Markdown", "NotificationBadge", "Progress", "ProgressCircle", "RichSelect", "SegmentedProgress", "Spinner", "StatCard", "StatusDot", "StatusIndicator", "Switch", "Tag", "Toast"}

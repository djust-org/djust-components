# djust-components (DEPRECATED)

**This package is deprecated.** All functionality has been folded into the main [djust](https://github.com/johnrtipton/djust) package as of djust v0.5.0. Install djust and import from `djust.components` instead.
...
```
```python
from djust_components import Modal, Accordion, Tabs, render_icon, push_toast
```
...
```
```python
from djust.components import Modal, Accordion, Tabs, render_icon, push_toast
```
